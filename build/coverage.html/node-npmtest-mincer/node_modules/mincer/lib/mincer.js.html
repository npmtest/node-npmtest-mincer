...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-mincer/node_modules/mincer/lib/mincer.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-mincer/node_modules/mincer/lib/mincer.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-mincer/node_modules/mincer/lib/</a> &#187; mincer.js</div>
</div>
<div class="body">
...
&nbsp;
fs.exists     = fs.exists || <span class="branch-1 cbranch-no" title="branch not covered" >path.exists;</span>
fs.existsSync = fs.existsSync || <span class="branch-1 cbranch-no" title="branch not covered" >path.existsSync;</span>
&nbsp;
path.sep = path.sep || (<span class="branch-1 cbranch-no" title="branch not covered" >path.resolve('.')[0] === '/' ? '/' : '\\')</span>;
&nbsp;
&nbsp;
// 3rd-party
...
Mincer.registerConfiguration('autoprefixer', {
  enable: <span class="fstat-no" title="function not covered" >function (self) {</span>
<span class="cstat-no" title="statement not covered" >    self.registerPostProcessor('text/css', Mincer.Autoprefixer);</span>
  },
  disable: <span class="fstat-no" title="function not covered" >function (self) {</span>
<span class="cstat-no" title="statement not covered" >    self.unregisterPostProcessor('text/css', Mincer.Autoprefixer);</span>
  }
});
&nbsp;
&nbsp;
...
Mincer.registerConfiguration('source_map', {
  state:    'disabled',
  enable:   <span class="fstat-no" title="function not covered" >function (self) {</span> <span class="cstat-no" title="statement not covered" >self.enable('source_maps'); </span>},
  disable:  <span class="fstat-no" title="function not covered" >function (self) {</span> <span class="cstat-no" title="statement not covered" >self.disable('source_maps'); </span>}
});
&nbsp;
&nbsp;</pre></td></tr>
</table></pre>
