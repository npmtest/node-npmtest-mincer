...
&nbsp;
  ...
  prop(this, '__trail__',             new Hike(root || <span class="branch-1 cbranch-no" title="branch not covered" >'.')</span>);
...
&nbsp;
  // append paths
  _.forEach(Mincer.paths, <span class="fstat-no" title="function not covered" >function (path) {</span>
