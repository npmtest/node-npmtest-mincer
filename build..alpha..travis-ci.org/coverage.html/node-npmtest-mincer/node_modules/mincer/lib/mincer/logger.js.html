...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-mincer/node_modules/mincer/lib/mincer/logger.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-mincer/node_modules/mincer/lib/mincer/logger.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-mincer/node_modules/mincer/lib/mincer/</a> &#187; logger.js</div>
</div>
<div class="body">
 ...
 *      Logger.Level(4);
 **/
module.exports.level = <span class="fstat-no" title="function not covered" >function (ignoreBelow) {</span>
<span class="cstat-no" title="statement not covered" >  levelToReport = parseInt(ignoreBelow, 10) || 0;</span>
 ...
 *      Logger.use(console);
 **/
module.exports.use = <span class="fstat-no" title="function not covered" >function (logger) {</span>
<span class="cstat-no" title="statement not covered" >  backend = logger;</span>
<span class="cstat-no" title="statement not covered" >  return this;</span>
};
&nbsp;
&nbsp;
...
&nbsp;
  // e.g. Logger.log
  module.exports[level] = <span class="fstat-no" title="function not covered" >function (message) {</span>
    // ignore if level is less then `levelToReport`
<span class="cstat-no" title="statement not covered" >    if (index &lt; levelToReport) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (_.isFunction(backend[level])) {</span>
<span class="cstat-no" title="statement not covered" >      backend[level](message);</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
    // fallback to `backend.log`
<span class="cstat-no" title="statement not covered" >    (backend.log || DEAF_LOGGER.log)(level, message);</span>
  };
});
&nbsp;
&nbsp;</pre></td></tr>
