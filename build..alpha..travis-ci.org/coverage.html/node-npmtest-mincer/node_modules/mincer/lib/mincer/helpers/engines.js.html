...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-mincer/node_modules/mincer/lib/mincer/helpers/engines.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-mincer/node_modules/mincer/lib/mincer/helpers/engines.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-mincer/node_modules/mincer/lib/mincer/helpers/</a> &#187; engines.js</div>
</div>
<div class="body">
 ...
 *      // -&gt; StylusEngine
 **/
module.exports.getEngines = <span class="fstat-no" title="function not covered" >function (ext) {</span>
<span class="cstat-no" title="statement not covered" >  if (ext) {</span>
<span class="cstat-no" title="statement not covered" >    return this.__engines__[normalizeExtension(ext)];</span>
  }
<span class="cstat-no" title="statement not covered" >  return _.clone(this.__engines__);</span>
};
&nbsp;
&nbsp;
/**
 ...
 *      // -&gt; ['.coffee', '.sass', ...]
 **/
getter(module.exports, 'engineExtensions', <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >  return _.keys(this.__engines__);</span>
});
&nbsp;
&nbsp;
/**
